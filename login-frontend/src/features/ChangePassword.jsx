      ...
      <form className={styles.form} onSubmit={handleSubmitPassword}>
        <div className={styles.inputContainer}>
          ...
          <label className={styles.label}>
            ...
            {touched && oldPasswordError && (<div className={styles.errorText}>{oldPasswordError}</div>)}
          </label>
          <label className={styles.label}>
            ...
            {touched && newPasswordError && (<div className={styles.errorText}>{newPasswordError}</div>)}
          </label>
        </div>
